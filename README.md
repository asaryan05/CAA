...
Topic: Software protection using obfuscation algorithms. Goal: Implement two obfuscation techniques — XOR string encoding and dead-code + control-flow obfuscation — in both Python and C++, plus an advanced C++ example using macros, templates, and inline assembly.
...
inline-asm function disassembly
...
Determined attackers with a decompiler can still reconstruct logic — obfuscation
